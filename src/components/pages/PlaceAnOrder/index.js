            ...
            {open &&
                <div className={`box-select-people mb-20 box-select-people-open`}>
                    <div className='d-flex box-select-people-right'>
                        ...
                        {tour.type === 1 ? <div className='price-select-people'>{formatter.format(tour.adultPrice)}{languageSelected === 'EN' ? '/person' : '/người'}</div>
                            :
                    ...
                    <div className='d-flex box-select-people-right'>
                        ...
                        {tour.type === 1 ? <div className='price-select-people'>{formatter.format(tour.childrenPrice)}{languageSelected === 'EN' ? '/child' : '/trẻ em'}</div>
                            :
                            <div className='price-select-people' />}
