...
function TourSchedule({ languageSelected, tour, tourSchedule, setTourSchedule, serviceList, isDisabled }) {
    ...
    const getListServiceRecommend = (value, index, isChangeCity) => {
        let getService = [[], [], []]
        axios.get(API_GET_SERVICE_BY_CONDITION, {
            ...
            data.forEach(item => {
                getService[parseInt(item.serviceCategory) - 1].push({
                            ...
                            <div className='animation-show'>
                                <div className='pd-30-20'>
                                    ...
                                    <div className="d-flex line-input mb-25">
                                        <div className="mlr-50 input-alone">
                                            <label className="d-block title-create-tour">{languageList.txtRecommendedAccommodation}</label>
                                    ...
                                    <div className="d-flex line-input mb-25">
                                        <div className="mlr-50 input-alone">
                                            <label className="d-block title-create-tour">{languageList.txtRecommendedEntertainment}</label>
                                            <Select onFocus={(e) => handleFocus(e.target)}
                                                onBlur={(e) => handleBlur(e.target)}
                                                isSearchable={true}
                                                placeholder=''
                                    ...
                                    <div className="d-flex line-input mb-25">
                                        <div className="mlr-50 input-alone">
                                            <label className="d-block title-create-tour">{languageList.txtRecommendedRestaurants}</label>
                                            <Select onFocus={(e) => handleFocus(e.target)}
                                                onBlur={(e) => handleBlur(e.target)}
                                                isSearchable={true}
